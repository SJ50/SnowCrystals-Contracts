...
// Part: openzeppelin/openzeppelin-contracts@3.2.0/ERC20Burnable
...
contract Toast is ERC20Taxable {
    // Initial distribution for the first 48h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 20_000 ether;
    // Distribution for airdrops wallet
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 1_000 ether;
     ...
     */
    constructor() public ERC20Taxable("Toast", "TOAST") {
        // Mints 4_000 TOAST to contract creator for initial pool setup.
        _mint(msg.sender, 4_000 ether);
    }
    ...
    function distributeReward(address _genesisPool, address _airdropWallet)
        external
        onlyOperator
    {
    ...
    function _updateSnowPrice() internal override {
        ITaxOffice(taxOffice)._updateMainTokenPrice();
    }
